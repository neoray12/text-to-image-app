...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/text-to-image-app
```

A live public deployment of this template is available at [https://text-to-image-app.templates.workers.dev](https://text-to-image-app.templates.workers.dev)
